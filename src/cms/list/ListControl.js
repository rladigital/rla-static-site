...
const TopBar = ({
    ...
    <div className="nc-listControl-topBar">
        <div className="nc-listControl-listCollapseToggle">
            ...
            {itemsCount}{" "}
            {itemsCount === 1 ? getSingularLabel(listLabel) : listLabel}
        </div>
        ...
        {types && (
            <div className="nc-toolbar-dropdown" style={{ zIndex: 100 }}>
                <Dropdown
                    ...
                    renderButton={() => (
                        <DropdownButton className="nc-listControl-addButton">
                            Add {getSingularLabel(listLabel)}{" "}
...
export default class ListControl extends Component {
    ...
    constructor(props) {
        ...
        const itemsCollapsed =
            value && Array(value.size).fill(allItemsCollapsed);
    ...
    objectLabel(item) {
        ...
        const labelField = this.isModular
            ? item
        ...
        return (
            <div id={forID} className={c(classNameWrapper, "nc-listControl")}>
                <TopBar
                    ...
                    listLabel={
                        this.isModular
                            ? field.get("label").toLowerCase()
                            : label.toLowerCase()
                    }
                    onCollapseAllToggle={this.handleCollapseAllToggle}
                    allItemsCollapsed={itemsCollapsed.every(
                        val => val === true
                    )}
